...
import PublicLanding from '../PublicLanding/PublicLanding';

interface ProtectedManagementProps {
  children: ReactNode;
}

export default function ProtectedManagement({ children }: ProtectedManagementProps) {
